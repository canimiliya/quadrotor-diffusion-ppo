...
def main():
    curve=list(csv.DictReader((OUT/"training_curve.csv").open(encoding="utf-8",newline="")))
    ...
    metrics=[]; family=[]; unet_by_pass={"0":{"status":"INITIAL_UNTRAINED","count":0,"success_rate":None}}
